...
func FormatLevels(level int, format string, args ...interface{}) (string, []interface{}) {
	gid := GetGID()
	args = append([]interface{}{LevelName(level), "GID", gid}, args...)
	return "%s %s %d " + format + "\n", args
}
...
func InfoO(format string, a interface{}, b ...interface{}) {
	Log.Infof(format, YamlString(a), b)
}
